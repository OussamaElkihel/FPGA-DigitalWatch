...
--synthesis_resources = 
 ...
 ENTITY  montre_cmd_xbar_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END montre_cmd_xbar_demux;

 ARCHITECTURE RTL OF montre_cmd_xbar_demux IS
	 ...
	 SIGNAL  s_wire_montre_cmd_xbar_demux_wideor0_15_dataout :	STD_LOGIC;
